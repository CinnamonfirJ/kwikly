              ...
              <div className='flex md:flex-row flex-col justify-between md:items-center gap-6'>
                <div>
                  ...
                  <p className='text-gray-600 leading-relaxed'>
                    Update your quiz details, questions, and settings to keep
              ...
              {activeTab === "basic" ? (
                <div className='space-y-8'>
                  ...
                  <div className='gap-6 grid md:grid-cols-2'>
                    ...
                    <div className='group relative'>
                      <div className='absolute -inset-1 bg-gradient-to-r from-gray-300 to-gray-400 opacity-0 group-hover:opacity-20 rounded-2xl transition duration-300 blur'></div>
                      <div className='relative bg-white/80 shadow-lg backdrop-blur-sm p-6 border border-gray-100/50 rounded-2xl'>
                        <label className='flex items-center gap-2 mb-3 font-semibold text-gray-800'>
                        ...
                        <input
                          type='text'
                          className='bg-gray-50 p-4 border border-gray-200 rounded-xl w-full font-mono font-medium text-gray-600'
                          value={code}
                          disabled
                          readOnly
                        />
                        <p className='mt-2 text-gray-500 text-xs'>
                          Quiz code cannot be changed after creation
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-600 text-sm'>
                          Update and organize your quiz questions
                        </p>
                      </div>
                    </div>
                    <div className='flex items-center gap-3'>
                    ...
                    <div className='group relative'>
                      ...
                      <div className='relative bg-white/60 backdrop-blur-sm p-12 border-2 border-gray-300 border-dashed rounded-3xl text-center'>
                        ...
                        <p className='mb-6 text-gray-500'>
                          Click &#34;Add Question&#34; to start adding content
                          to your quiz
                        </p>
                        <button
                          onClick={addQuestion}
